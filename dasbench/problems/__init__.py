...
from dasbench.problems.dfvs import PROBLEM as DFVS_PROBLEM
from dasbench.problems.hitting_set import PROBLEM as HITTING_SET_PROBLEM
...
from dasbench.problems.ocm import PROBLEM as OCM_PROBLEM
...
PROBLEMS: dict[str, ProblemDefinition] = {
    ...
    "dfvs": DFVS_PROBLEM,
    "hitting_set": HITTING_SET_PROBLEM,
    "mdkp": MDKP_PROBLEM,
